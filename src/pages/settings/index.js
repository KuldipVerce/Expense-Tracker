...
const TrackerSettings = () => {
	...
	const { currentLang, changeLanguage, currentCurrency, changeCurrency } =
	...
	return (
		<Layout>
			<div className={styles.s__content}>
				...
				<p className={styles.s__description}>
				...
				<div className={styles.grid}>
					...
					<Button
						onClick={() =>
							changeCurrency(
								currentCurrency === "INR" ? "USD" : "INR"
							)
						}
					>
						<DollarIcon />
						<span>{currentCurrency === "INR" ? "INR" : "USD"}</span>
					</Button>
